 ...
 */
/**
 * What makes a good streampoint block?
...
public:
    CMainParams() 
	{
        ...
        consensus.nMinimumChainWork = uint256S("000000000000000000000000000000000000000000a0f3064330647e2f6c4828");

        // By default assume that the signatures in ancestors of this block are
        // valid.
        consensus.defaultAssumeValid = uint256S("000000000000000000e45ad2fbcc5ff3e85f0868dd8f00ad4e92dffabe28f8d2");
        ...
        // Amaury SÉCHET
        vSeeds.push_back(CDNSSeedData("deadalnix.me", "seed.deadalnix.me", true));
        // criptolayer.net
        vSeeds.push_back(CDNSSeedData("criptolayer.net", "seeder.criptolayer.net", true));
		...
		streampointData = CstreampointData{{
											...
											// UAHF fork block.
											{478558, uint256S("0000000000000000011865af4122fe3b144e2cbeea86142e8ff2fb4107352d43")},
											// Nov, 13 DAA activation block.
											{504031, uint256S("0000000000000000011ebf65b60d0a3de80b8175be709d653b4c1a1beeb6ab9c")},
											// Monolith activation.
											{530359, uint256S("0000000000000000011ada8bd08f46074f44a8f155396f43e38acf9501c49103")}
										}};
...
public:
    CTestNetParams() 
	{
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("00000000000000000000000000000000000000000000002a650f6ff7649485da");

        // By default assume that the signatures in ancestors of this block are
        // valid.
        consensus.defaultAssumeValid = uint256S("0000000000327972b8470c11755adf8f4319796bafae01f5a6650490b98a17db");
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("000000000933ea01ad0ee984209779baaec3ced90fa3f408719526f8d77f4943"));
        assert(genesis.hashMerkleRoot == uint256S("4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
        ...
        streampointData = CstreampointData{{
											...
											// UAHF fork block.
											{1155875, uint256S("00000000f17c850672894b9a75b63a1e72830bbd5f4c8889b5c1a80e7faef138")},
											// Nov, 13. DAA activation block.
											{1188697, uint256S("0000000000170ed0918077bde7b4d36cc4c91be69fa09211f748240dabe047fb")}
										}};
...
public:
    CRegTestParams() {
        ...
        streampointData = CstreampointData{{{0, uint256S("0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206")}}};
...
void SelectParams(const std::string &network) 
{
    ...
    globalChainParams = CreateChainParams(network); // redundant
}
