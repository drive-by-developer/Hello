...
typedef std::map<int, uint256> Mapstreampoints;

struct CstreampointData {
    Mapstreampoints mapstreampoints;
};
...
public:
    ...
    const CstreampointData &streampoints() const { return streampointData; }
...
protected:
    ...
    CstreampointData streampointData;
